...
public abstract class AbstractMusicVoiceCommand extends VoiceCommand {

    private static final Logger logger = LoggerFactory.getLogger(AbstractMusicVoiceCommand.class);

    public AbstractMusicVoiceCommand(VoiceCommandHandler voiceCommandHandler) {
